...
test("settings PUT round-trips the payload", async () => {
  ...
  vi.stubGlobal("fetch", fetchMock);
  await api.updateUserSettings({theme:"dark", language:"de", codec:"h264-aac-mp4", zoom:110, dateFormat:"iso", streamChunkSize:25, defaultThumbImage:"m", defaultThumbVideo:"m", defaultThumbFolder:"m", mapTileProviderLight:"osm", mapTileProviderDark:"carto", mapMaxZoom:19, poiProviderLight:"overpass", poiProviderDark:"overpass", poiProviders:{overpass:{}}, thumbMin:90, thumbMax:0});
